...
class service(models.Model):
    ...
    check1 = models.CharField(max_length=100, default='')
    check2 = models.CharField(max_length=100, default='')
...
class noninventory(models.Model):
    ...
    invacnt = models.CharField(max_length=100, default='')
    expacnt = models.CharField(max_length=100, default='')
    incomeacnt = models.CharField(max_length=100, default='')
    purtax = models.CharField(max_length=100, default='')
    date = models.DateField(default=datetime.date.today)
    purchaseinfo = models.TextField(default='')
    salesprice = models.DecimalField(max_digits=10, decimal_places=2, default='0')
    description = models.TextField(default='')
    stockalrt = models.IntegerField(default='0')
    initialqty = models.IntegerField(default='0')
