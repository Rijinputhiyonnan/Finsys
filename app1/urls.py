...
path('search_retinvoice',views.search_retinvoice,name='search_retinvoice'),
  ...
  path('edit/<int:pk>/', views.edit_bank_account_holder, name='edit'),
 path('accounts/<int:pk>/', views.bank_account_holder_detail, name='bank_account_holder_detail'),
path('accounts/<int:pk>/activate/', views.activate_bank_account_holder, name='activate_bank_account_holder'),
